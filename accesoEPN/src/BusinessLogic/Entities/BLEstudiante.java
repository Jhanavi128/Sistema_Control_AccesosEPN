...
public class BLEstudiante extends Estudiante {
    ...
    /**
     * Obtiene un estudiante por su ID de usuario y carga los datos de su carrera/periodo
     */
        ...
        if (est != null && est.getIdPeriodo() != null) {
            try {
                ...
                if (per != null) {
                    ...
                    System.out.println("LOG: Periodo encontrado -> " + per.getNombre() + " Carrera -> " + per.getCarrera());
