...
public class BLRegistroIngreso {
    ...
    private final FactoryBL<RegistroIngresoDTO> factory = new FactoryBL<>(RegistroIngresoDAO.class);
    ...
    public void registrarIngreso(Integer idUsuario,
        ...
        try {
            ...
            // Seteamos 'A' para que sea visible en las consultas activas (como el
            // AdminPanel)
            dto.setEstado("A");
            ...
            throw new AppException("Error al procesar el registro de ingreso", e, BLRegistroIngreso.class,
                    "registrarIngreso");
        }
    }
    ...
    public List<RegistroIngresoDTO> obtenerTodos() throws AppException {
        try {
            ...
            throw new AppException("Error al recuperar el historial de ingresos", e, BLRegistroIngreso.class,
                    "obtenerTodos()");
        }
    }

    public void eliminarTodoHistorial() throws AppException {
        RegistroIngresoDAO dao = new RegistroIngresoDAO();
